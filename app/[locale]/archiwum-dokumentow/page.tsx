...
export async function generateMetadata({
  ...
  return {
    title: isEn
      ? "Document Archive Storage | LOCKIT Szczecin"
      : "Przechowywanie dokumentów i archiwum | LOCKIT Szczecin",
    description: isEn
    ...
    alternates: {
      canonical: `https://lockit.pl/${locale === "pl" ? "" : "en/"}archiwum-dokumentow`,
      languages: {
        pl: "https://lockit.pl/archiwum-dokumentow",
        en: "https://lockit.pl/en/archiwum-dokumentow",
      },
    },
  };
}
